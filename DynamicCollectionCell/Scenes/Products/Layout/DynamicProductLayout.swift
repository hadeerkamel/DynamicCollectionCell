...
class DynamicProductLayout: UICollectionViewLayout {

    var delegate: DynamicProductLayoutDelegate!
    var numberOfColumns = 2
    var cellPadding: CGFloat = 5
    var cacheAttributes = [DynamicProductLayoutAttributes]()
    ...
    override class var layoutAttributesClass : AnyClass {
        return DynamicProductLayoutAttributes.self
    }
    ...
    override func prepare() {
        if cacheAttributes.isEmpty {
            ...
            for item in 0..<collectionView!.numberOfItems(inSection: 0) {
                ...
                let attributes = DynamicProductLayoutAttributes(forCellWith: indexPath)
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        var layoutAttributes = [DynamicProductLayoutAttributes]()
